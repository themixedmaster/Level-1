...
public class DrumKit extends MouseAdapter {
    ...
    private void getGoing() throws MalformedURLException {
   	 // 1. Make a JFrame variable and initialize it using "new JFrame()"
   	 	JFrame qwertyuiopas = new JFrame();
   	 // 2. Make the frame visible
   	 	qwertyuiopas.setVisible(true);
   	 // 3. Set the size of the frame
   	 	qwertyuiopas.setSize(500, 500);
   	 // 4. Set the title of the frame
   	 	qwertyuiopas.setTitle("8loi");
   	 // 5. Make a JPanel and initialize it.
   	 	JPanel qwert = new JPanel();
   	 // 6. Add the panel to the frame. (The panel is invisible.)
   	 	qwertyuiopas.add(qwert);
   	 // 7. Download an image of a drum from the Internet. Drop it into your Eclipse project under "default package".
   	 // 8. Put the name of your image in a String variable.
    String casualBongos = "g.jpg";
   	 // 9. Edit the next line to use your String variable
    drumLabelWithImage = createLabelImage(casualBongos);
   	 
   	 // 10. Add the image to the panel
    qwert.add(drumLabelWithImage);
   	 // 11. Set the layout of the panel to "new GridLayout()"
    qwert.setLayout(new GridLayout());
